  ...
  return (
    <div className="space-y-12 max-w-3xl">
      ...
      <section>
        ...
        {/* 本文 */}
        <p className="text-black text-base font-medium leading-loose mb-8">
        ...
        <div className="space-y-3">
          <Link
            ...
            className="flex items-center gap-3 bg-[#bae6fd] hover:bg-[#7dd3fc] transition-all px-4 py-3.5 rounded-lg text-black text-base group shadow-sm"
          >
      ...
      <section className="pt-6">
        ...
        {/* 文字を少し大きく（text-[17px] md:text-[18.5px]）、濃く（text-neutral-900 font-medium）設定 */}
        <div className="space-y-6 text-neutral-900 text-[17px] md:text-[18.5px] leading-[2.15] tracking-wide font-medium">
          ...
          <p>
            自分なりにぶつぶつ考えたことを主にブログみたいな感じで気ままに更新していく予定です。
          </p>
